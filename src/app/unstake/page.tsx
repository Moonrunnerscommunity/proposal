          ...
          <div className="glass-dark border border-[rgba(138,111,183,0.18)] shadow-2xl rounded-2xl p-6 md:p-10 backdrop-blur-md">
            {!isConnected ? (
              ...
              <Tabs defaultValue="primordia">
                <TabsList className="w-full flex flex-col sm:flex-row justify-between overflow-hidden bg-[rgba(44,27,80,0.7)] border border-[rgba(138,111,183,0.18)] rounded-xl mb-8 p-0 shadow-md">
                  <TabsTrigger
                    value="primordia"
